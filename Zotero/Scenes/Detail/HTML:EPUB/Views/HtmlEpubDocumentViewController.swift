    ...
    private func injectVerticalScrollPagination(marginTop: CGFloat, navBarHeight: CGFloat, cfi: String) {
        ...
        (function(){
            ...
            function adjustAfterScroll() {
                ...
                // Snap top: if the first visible line is partially cut, scroll past it
                try {
                ...
                // Bottom clip: hide partial last line
                var bottomClip = 0;
                try {
                ...
                // Clip sections bottom to hide partial line
                sections.style.clipPath = bottomClip > 0 ? 'inset(0 0 ' + bottomClip + 'px 0)' : '';

                // Clip annotation overlay to match sections visible area
